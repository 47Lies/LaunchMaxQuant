...
#
#
SampleDescriptionFile=${WD}/Celine.SmallSet.SampleDescription.txt
DatabaseFastaFile=${WD}/uniprot_concat_human_OX10359.fasta
...
#
#
TemplateMqparFile=/data/users/ltaing/DATA_TMP/ltaing/Celine/mqpar.Celine_4T.d.Prototype.xml
...
if [[ -f "$TemporaryMqparFile" ]];
then
 rm ${TemporaryMqparFile}
fi
